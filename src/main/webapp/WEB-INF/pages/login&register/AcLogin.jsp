		...
		<div class="col-md-4 " class="logindiv"
			...
			<form>
				<div class="form-group">
					<label for="InputAcNum">账号</label> <input type="text"
						class="form-control" id="InputAcNum" placeholder="请输入管理员账号">
					<span class="help-block"></span>
				</div>
				<div class="form-group">
					<label for="InputAcPwd">密码</label> <input type="password"
						class="form-control" id="InputAcPwd" placeholder="请输入密码">
					<span class="help-block"></span>
				</div>
				<div class="checkbox">
